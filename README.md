...
详细条款请阅读  [LICENSE.md] (📁%200-插件/obsidian-bangumi/LICENSE.md) 文件。
...
[Donate.md](0-插件/obsidian-bangumi/yuangwu/Donate.md)
...
您可以在个人非商业用途下免费使用，但必须遵守最终用户许可协议（EULA）中的各项限制。详细条款请见 [LICENSE.md](📁%200-插件/obsidian-bangumi/LICENSE.md)（或插件内置 EULA 弹窗）。
